This module is derivative from Model module (https://drupal.org/project/config_pages)

Below is original README From Model module
...
You can add config_pages entities via
...
searching and replacing the word "config_pages" with the actual name I want to give my
...
config_pages.admin.inc and customize the behaviour of your entity on save, delete which you
do via the ModelController class in config_pages.module.
...
to your table)  - just like the config_pages entity does with the checkbox - there is nothing
else you need to do. If you have added new columns you need to add support for them
in $config_pages->create but not necessarily $config_pages->save unless you are doing something specific.

3. Finally you can play around within the theming for your entity by looking into config_pages.tpl.php and
config_pages-sample-data.tpl.php
